...
```
git clone https://github.com/Blockchain-Oracle/Nft-Market-Place-graphq
cd Nft-Market-Place-graphq
yarn
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://github.com/Blockchain-Oracle/Nft-Market-Place-graphql)
