...
export class ItemCanclled extends ethereum.Event {
  get params(): ItemCanclled__Params {
    return new ItemCanclled__Params(this);
  }
}

export class ItemCanclled__Params {
  _event: ItemCanclled;

  constructor(event: ItemCanclled) {
    this._event = event;
  }
...
export class itemList extends ethereum.Event {
  get params(): itemList__Params {
    return new itemList__Params(this);
  }
}

export class itemList__Params {
  _event: itemList;
...
export class NftMarket extends ethereum.SmartContract {
  ...
  getProcceds(seller: Address): BigInt {
    let result = super.call("getProcceds", "getProcceds(address):(uint256)", [
  ...
  try_getProcceds(seller: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getProcceds",
      "getProcceds(address):(uint256)",
      [ethereum.Value.fromAddress(seller)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
